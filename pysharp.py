...
def translate_expression(expression):
    ...
    # Replace double-quoted and single-quoted literals with placeholders.
    ...
    # Let plugins transform expressions (operate on masked expression)
...
def translate_statement(statement):
    ...
    if for_match:
        # groups: optional type, var, start, end
    ...
    if plugin_out:
        # If plugin indicates the result should be reprocessed, do that.
